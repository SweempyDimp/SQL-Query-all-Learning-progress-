...
insert into emp_data values('A1102', 'TESTB', '01-FEB-2025', 'BANG', null)
...
-- UPDATE
select * from emp_data
update emp_data set emp_name = 'TESTC' where emp_id = 'A1104'

update emp_data set emp_name = 'TESTD', EMP_Email = 'abcd1@gmail.com' where emp_id = 'A1104'

update emp_data set emp_doj = '01-feb-2025'

--query
update emp_data set emp_loc = 'BANG' where emp_loc = null

update emp_data set emp_email = null where emp_id = 'A1101'
...
insert into emp_data1 values('a1101', 'testa', '01-jan-2025', 9000)
insert into emp_data1 values('a1102', 'testb', '01-jan-2025', 9000)
insert into emp_data1 values('a1103', null, '01-jan-2025', 9000)


insert into emp_data1 values(null, 'testc', '01-jan-2025', 9000)
----
...
INSERT into emp_data2 values('a1101', 'abcd', '01-jan-2025', 15000)

-- query  --

create table CONS_01
(STUD_ID		 char(6)		 not null	unique,
STUD_NAME		 varchar(60)	 not null,
STUD_FEE		 numeric(8,1)    check (STUD_FEE>=15000))

INSERT into emp_data2 values('a11011', 'abcd', 150)
select * from cons_01
----

-- primary key --        -- used to stop null values/duplicates
-- default --        -- changes default from null to any other value that you give
...
insert into emp_data_02 values (11, 'abcd', 'pune')
insert into emp_data_02 (EMPID, EMPNAME) values (12, 'efgh')

select * from emp_data_02
...
(
empid int foreign key references emp_001(empid),
sal int,
MON varchar(20)
)
